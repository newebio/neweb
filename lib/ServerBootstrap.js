...
const server_1 = require("neweb-react/server");
...
const PageRenderer_1 = require("./neweb-components/server/PageRenderer");
...
class ServerBootstrap {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // neweb
            const pageRenderer = this.engine === "react" ? new server_1.ServerPageRenderer({
                app,
            }) : new PageRenderer_1.default({
                app,
            });
